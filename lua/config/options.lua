...
opt.opt.conceallevel = 0 -- mostra caracteres especiais
opt.opt.scrolloff = 8 -- mantém 8 linhas visíveis ao fazer scroll
opt.opt.sidescrolloff = 8
